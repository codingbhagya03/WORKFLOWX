...
const ProjectManager: React.FC = () => {
  ...
  return (
<Card className="p-6 max-w-7xl mx-auto mt-6 shadow-lg rounded-lg border">
<CardHeader>
<CardTitle className="text-2xl font-semibold">Project Manager</CardTitle>
</CardHeader>
 
      <CardContent>
<Button onClick={() => {
          setCurrentProject({ name: "", description: "", startDate: "", endDate: "", status: "Not Started", budget: 0, client: "", teamMembers: "" });
          setOpen(true);
        }}>
          Add Project
</Button>
...
<tr key={project._id} className="text-center border border-gray-300">
...
<td className="border border-gray-300 px-4 py-2">{project.teamMembers}</td>
...
<Button variant="outline" onClick={() => { setCurrentProject(project); setOpen(true); }}>Edit</Button>
...
<Label>Client</Label>
<Input type="text" value={currentProject?.client || ""} onChange={e => setCurrentProject({ ...currentProject, client: e.target.value })} />
