    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-40 p-0 font-normal aria-selected:opacity-100"
        ),
      ...
      components={{
        IconLeft: ({ ..._props }) => <ChevronLeft className="h-4 w-4 hidden" />,
        IconRight: ({ ..._props }) => <ChevronRight className="h-4 w-4 hidden" />,
      }}
      {...props}
    />
  );
